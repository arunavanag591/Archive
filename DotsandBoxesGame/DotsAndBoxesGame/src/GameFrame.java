...
public class GameFrame {
	...
	/**
	 * Initializing the variables or the contents that will be projected
	 */
	private void initialize() {
		//System.out.println("MADE IT TO INITIALIZE");-->> just to check if working properly
