...
public class AI {
	...
	public int makeMove()
	{
		...
		///////////////////////////////////////////////////////
		// as no score moves are found hence                 //
		// trying for a safe move                            //
		///////////////////////////////////////////////////////
		for(int i = 0; i < this.allBoxes.length; i++)
		{
			for(int x = 0; x < this.allBoxes[i].length; x++)
	...
	public int makeDumbMove()
	{
		...
		for(int i = 0; i < this.allBoxes.length; i++)
		{
			for(int x = 0; x < this.allBoxes[i].length; x++)
			{
				...
				//passing instruction that line is available. check it.
				if(this.allBoxes[i][x][0] == 0)
				{
					boolean willScore = false;
		...
		///////////////////////////////////////////////////////
		// when no score moves are found                     //
		// we try into safe moves                            //
		///////////////////////////////////////////////////////
		for(int i = 0; i < this.allBoxes.length; i++)
		{
			for(int x = 0; x < this.allBoxes[i].length; x++)
